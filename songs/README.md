...
| File | Track |
|------|-------|
| `thriller.mp3` | Thriller — Michael Jackson |
| `beat-it.mp3` | Beat It — Michael Jackson |
| `billie-jean.mp3` | Billie Jean — Michael Jackson |
| `smooth-criminal.mp3` | Smooth Criminal — Michael Jackson |
| `dont-stop.mp3` | Don't Stop 'Til You Get Enough — Michael Jackson |
| `shape-of-you.mp3` | Shape of You — Ed Sheeran |
| `azizam.mp3` | Azizam — Ed Sheeran |
| `nochentera.mp3` | Nochentera — Vicco & Larry DJ |
| `speed.mp3` | Speed |
| `minecraft-calm-1.mp3` | Minecraft — Calm 1 |
